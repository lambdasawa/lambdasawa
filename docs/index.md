...
- 関連書籍
  - [AWS の薄い本　 IAM のマニアックな話](https://www.amazon.co.jp/dp/B085PZCMG2)
...
- [s3 — AWS CLI Command Reference](https://docs.aws.amazon.com/cli/latest/reference/s3/index.html#use-of-exclude-and-include-filters)
...
- [open-telemetry/opentelemetry-lambda](https://github.com/open-telemetry/opentelemetry-lambda)
  - [collector/lambdacomponents/default.go](https://github.com/open-telemetry/opentelemetry-lambda/blob/main/collector/lambdacomponents/default.go)
...
- [aws-observability/aws-otel-collector](https://github.com/aws-observability/aws-otel-collector)
  - [pkg/lambdacomponents/defaults.go](https://github.com/aws-observability/aws-otel-collector/blob/main/pkg/lambdacomponents/defaults.go)
  - [pkg/defaultcomponents/defaults.go](https://github.com/aws-observability/aws-otel-collector/blob/main/pkg/defaultcomponents/defaults.go)
...
- [Terraform 開発時の Developer Experience を爆上げする](https://zenn.dev/honmarkhunt/articles/2f03cba1ffe966)
...
- [MySQL の encoding を utf8 から utf8mb4 に変更して寿司ビール問題に対応する](https://techracho.bpsinc.jp/hachi8833/2020_11_26/25044)
- collation
...
- [DevelopersIO Elasticsearch 入門](https://dev.classmethod.jp/referencecat/enter-elasticsearch/)
...
- [InheritedWidget/InheritedModel とは何か - Qiita](https://qiita.com/ko2ic/items/d7b744f19f213ef1e647)
...
- [AtCoder Clans](https://kato-hiro.github.io/AtCoderClans/)
  ...
  - [数学を学ぶ](https://kato-hiro.github.io/AtCoderClans/articles/math/)
...
- <https://omise.smarthr.co.jp/collections/0>
  - 実用的(カニを除く) な絵文字の zip がダウンロードできる。

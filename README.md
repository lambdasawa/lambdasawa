...
- [XSS via chat information tooltip in open-webui/open-webui](https://huntr.com/bounties/ef06c7c8-1cb2-42a7-a6e6-17b2e1c744f7)
- [RCE by Non-Admin Users via CSRF in open-webui/open-webui](https://huntr.com/bounties/9350a68d-5f33-4b3d-988b-81e778160ab8)
- [Possible userinfo Leakage in `URI.join` / `URI#merge` in ruby](https://hackerone.com/reports/2957667)
- [Possible SSRF and Credential Leakage via Absolute URL in axios Requests](https://github.com/axios/axios/security/advisories/GHSA-jr5f-v2jv-69x6)
- [Potential SSRF Vulnerability in httparty Leading to API Key Leakage in httparty](https://github.com/jnunemaker/httparty/security/advisories/GHSA-hm5p-x4rq-38w4)
